jQuery(function($){
    ...
    let Shipping = {
        ...
        requestShipping : function( product_id, country ) {
            ...
            let response = [];
            let url = path + '&productid=' + product_id + '&country=' + country;
    ...
    let ImportProducts = {
        ...
        importRender : function( response ) {
            ...
            if( response.hasOwnProperty( 'error' ) ) {
                window.ADS.notify( response.error, 'danger' );
                $(document).find( act.btn ).find('.svg-icon').removeClass('spin-element');
            } else {
        ...
        handler : function() {
            ...
            $(document).on('click', act.btn, function(){
                ...
                th.find(act.btn).addClass( 'disabled' ).find( '.svg-icon' ).addClass( 'spin-element' );
            ...
            $(document).on( 'click', act.apply, function () {
                ...
                items.each( function () {
                    ...
                    item.find(act.btn).addClass( 'disabled' ).find( '.svg-icon' ).addClass( 'spin-element' );
